...
from src.utils.transformers.json_parsers import make_df_from_json_list, normalize_json_object
from src.pipelines.camara_deputados.schema import DeputadoSchema 
from pandera.errors import SchemaError
from src.utils.logger import logger_setting 

## urls
URL_DEPUTADOS_ATUAIS = "https://dadosabertos.camara.leg.br/api/v2/deputados?ordem=ASC&ordenarPor=nome"
...
def obter_ids_deputados_atuais():
    url = URL_DEPUTADOS_ATUAIS
    pasta_destino_json = PASTA_PARAMETROS
    
    data = make_http_request(url)
    response_to_json(data, pasta_destino_json, "id_deputados.json")
