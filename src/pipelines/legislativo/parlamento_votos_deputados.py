...
def extract_votos(cfg: PipelineConfig):
    ...
    for vot_id in ids_novos:
        ...
        output_file = f"{vot_id}_votos_deputados.json"
...
if __name__ == "__main__":
    PIPELINE_VOTOS_DEPUTADOS_PRD = {
        "parameter_file": "./src/params/full_id_votacoes.csv",
        "url_base": "https://dadosabertos.camara.leg.br/api/v2/votacoes/",
        "landing_dir": "/media/lucas/Files/2.Projetos/0.mylake/raw/demodados/camara/votos_deputados",
        "bronze_dir": "/media/lucas/Files/2.Projetos/0.mylake/bronze/demodados/camara/votos_deputados",
        "error_dir": "./data/error/camara/votos_deputados/",
        "bronze_file": "parlamento_votos_deputados.csv",
        "db_table": "raw_parlamento_votos_deputados",
    }

    run_deputados_pipeline(PipelineConfig(**PIPELINE_VOTOS_DEPUTADOS_PRD))
